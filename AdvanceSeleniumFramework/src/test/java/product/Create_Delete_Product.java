...
public class Create_Delete_Product {
	...
	public static void main(String[] args) throws Throwable, Throwable {
	    ...
	    FileInputStream fis = new FileInputStream("./src/test/resources/newdata.properties");
		...
		FileInputStream fis1 = new FileInputStream("C:\\Users\\Guest2\\Downloads\\Book 4 (5).xlsx");
